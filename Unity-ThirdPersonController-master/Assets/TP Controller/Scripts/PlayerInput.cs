...
//	public static Quaternion GetMouseRotationInput(float mouseX,float mouseY, float mouseSensitivity = 3f, float minTiltAngle = -75f, float maxTiltAngle = 45f)
	public static Quaternion GetMouseRotationInput(float mouseX,float mouseY, float mouseSensitivity = 0.5f, float minTiltAngle = -45f, float maxTiltAngle = 15f)
    {
